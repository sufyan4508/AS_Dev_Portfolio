...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: '/projects/admin-dashboard.png',
     description: 'Animated full-stack ERP tracker with brand-aligned analytics.',
    features: [
        'Custom weave interface with responsive animated layout grids',
        'Interactive real-time data insights via dynamic charts',
        'Decoupled full-stack architecture with local dataset fallback',
    ],
    tech: ['Next.js 14', 'Node.js', 'Express', 'TypeScript', 'Supabase (PostgreSQL)', 'Tailwind CSS', 'Framer Motion', 'Recharts', 'Vercel', 'Railway'],
