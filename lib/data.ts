...
export const projects: Project[] = [
  ...
  {
    title: 'Al-Mehrab Enterprise',
    category: 'web',
    categoryLabel: 'Dashboard',
    image: '/projects/admin-dashboard.png',
    description: 'Full-stack enterprise ERP implementation tracker with custom animated data visualization.',
    features: [
        'Signature animated warp and weft weave interface tailored for textile workflows',
        'Interactive data insights with hoverable donut layers and dynamic stacked bar charts',
        'Decoupled system architecture isolating analytical state with full local backup capabilities',
    ],
    tech: ['Next.js 14', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Recharts', 'Node.js', 'Express'],
    github: 'https://github.com/sufyan4508/Al-Mehrab-Dashboard',
    demo: 'https://al-mehrab-dashboard.vercel.app/',
  },
  {
